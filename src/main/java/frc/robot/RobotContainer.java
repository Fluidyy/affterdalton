...
//  private final Climb climbsub = new Climb();
  ...
  //  NamedCommands.registerCommand("peiceintake", new ParallelCommandGroup(intakesub.intakeCommand(0.3),intakesub.feederCommand()));
    ...
    lime.trustLL(true);
    lime.useLimelight(true);
    lime.setAlliance(Alliance.Blue);
...
UnjamButton.whileTrue(new SequentialCommandGroup(intakesub.UnjamFeeder(0.4))).whileFalse(intakesub.UnjamFeeder(0));


feaderf.whileTrue(intakesub.UnjamFeeder(-0.4)).whileFalse(intakesub.UnjamFeeder(0));
...
outakeunjam1.whileTrue(projectilesub.Outtake(-0.5)).whileFalse(projectilesub.Outtake(0));
    ...
    AutoaimSpeaker.whileTrue(
      ...
      )).whileFalse(new ParallelCommandGroup(intakesub.UnjamFeeder(0),boxpivsub.boxpivcmdTO(0)));
